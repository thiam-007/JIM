        ...
        <div class="contact-card-sidebar form-card">
          ...
          <div class="fb py-4 flex-col gap-3">
            ...
            <div class="direct-contact-item mt-2">
              ...
              <p class="text-muted">Expertise France, Ambassade de la France en Guinée et en Sierra Leone, Ministère de la Culture, du Tourisme et de l'Artisanat de Guinée.</p>
            </div>
          </div>
        </div>
      </div>
