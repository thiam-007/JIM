  ...
  <div class="form-panel active">
    <div class="form-card">
      ...
      <div class="fb">
        ...
        <div class="nl" :class="{ on: contactConsent }" @click="toggleContactConsent()">
          <div class="sw"></div>
          <span class="nl-lbl">📧 Le participant accepte d'être contacté·e après l'événement</span>
        </div>
        ...
        <div class="omsg" :class="{ on: submitted }">
          ...
          <button class="breset" @click="resetForm">+ Nouvelle inscription</button>
        </div>
      </div>
    </div>
  </div>
